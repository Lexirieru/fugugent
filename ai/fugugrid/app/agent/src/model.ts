...
/**
 * The Fugu Grid brain runs on dGrid — an OpenAI-compatible gateway to 200+ models.
 *
 ...
 * placing and managing grid orders, polling the pool's slot0() because PancakeSwap has no on-chain order book — is deterministic, backtestable code in
