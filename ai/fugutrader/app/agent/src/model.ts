...
/**
 * The Fugu Trader brain runs on dGrid — an OpenAI-compatible gateway to 200+ models.
 *
 ...
 * is deciding whether one paid request is worth paying for, is deterministic code in src/strategy/ that
