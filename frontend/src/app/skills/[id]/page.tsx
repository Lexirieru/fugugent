  ...
  return (
    <Page>
      ...
      <Section labelledBy="identity">
        <SectionHeader id="identity" title="Identity" />
        <Card>
...
function BackLink() {
  return (
    <Link href="/skills" className="text-sm text-muted transition hover:text-fg">
      ← All skills
    </Link>
  );
}
